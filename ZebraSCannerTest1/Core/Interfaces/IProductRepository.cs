...
namespace ZebraSCannerTest1.Core.Interfaces
{
    public interface IProductRepository
    {
        ...
        Task<Product?> IncrementScanAsync(string barcode, InventoryMode mode = InventoryMode.Standard, string? boxId = null, string? section = null, bool createIfMissing = false);
